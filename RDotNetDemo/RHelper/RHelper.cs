...
namespace RHelper
{
    ...
    public class RHelper : IDisposable
    {
        ...
        public List<SymbolicExpression> Evaluate(String cmd, Boolean executeLinewise)
        {
        ...
        public SymbolicExpression Evaluate(FileInfo scriptfile)
        {
            ...
            try
            {
                ...
                // Evaluate File and add Result to result list.
                s = this.rEngine.Evaluate(scriptfile.OpenRead());
            }
            catch (Exception ex)
            {
                throw ex;
